...
<header class="bg-white shadow p-4 flex justify-between items-center fixed w-full top-0 z-50">
    ...
    <div x-data="{ open: false }" class="relative">
        ...
        <nav :class="{'block': open, 'hidden': !open}" 
            ...
            <a href="/" class="block px-4 py-2 text-gray-800 hover:text-orange-200 sm:px-0 sm:py-0 transform transition hover:translate-x-2 hover:scale-105">Gallery</a>
            <a href="/shop" class="block px-4 py-2 text-gray-800 hover:text-orange-200 sm:px-0 sm:py-0 transform transition hover:translate-x-2 hover:scale-105">Shop</a>
        </nav>
    </div>
</header>

<!-- Main content -->
<main class="container mx-auto pt-28 px-4 sm:px-6">
    @yield('content')
</main>
